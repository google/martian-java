 ...
 * modifiers to be applied conditionally. QueryString Filter allows the
 * application of a modifier based on conditional matching of the
 * querystring parameters of the request or response.
 **/
public class QueryStringFilter implements Modifier {
    private static final String NAME = "querystring.Filter";
    ...
    /**
     * Writes Query String Filter JSON configuration message as well as the configuration
