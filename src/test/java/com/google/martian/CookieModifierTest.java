...
public class CookieModifierTest {
    ...
    public void testWriteJson() throws Exception {
        CookieModifier mod = new CookieModifier();
        mod.setScope(Scope.REQUEST);
        mod.setName("Martian-Cookie");
        mod.setValue("some value");
        mod.setPath("/some/path");
        mod.setDomain("example.com");
        mod.setSecure(true);
        mod.setHttpOnly(false);
        mod.setMaxAge(86400);
