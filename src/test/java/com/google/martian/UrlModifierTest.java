...
public class UrlModifierTest {
    ...
    public void testWriteJson() throws Exception {
        UrlModifier modifier = new UrlModifier();

        modifier.setScope(Scope.REQUEST);
        modifier.setScheme("https");
        modifier.setHost("www.martian.proxy");
        modifier.setPath("/testing");
        modifier.setQuery("test=true");
